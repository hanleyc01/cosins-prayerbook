...
\begin{titlingpage}
  \begin{center}
    ...
    \begin{figure}[!htpb]
      \centering
      \vspace{2mm}
      \framebox{\includegraphics[scale=0.14]{images/John_Cosin_Peterhouse.jpg}}
    \end{figure}
    \theauthor \\
    \vspace{0.2cm}
  \end{center}
...
This is a fun little project of transcribing some Rt. Rev. John Cosin's
...
religion anything of like continual rule and force throughout
every hour of our lives, as is the ghostly exercise of prayer
...
and purpose, our Savior taught and prescribed  them a form
...
A prayer, whereby we have not only Christ's name to countenance our suits,
(in whole name if we ask anything, as we ought to do, he hath offered us in his
...
for matter and form,
drawn up such supplications for us as will be most available and prevalent
...
thereby supplying with the fullness of that one, whatsoever may be
...
having heretofore been published among us by high and sacred authority, are now
...
all extemporal effusions of irksome and indigested prayers, which they
...
unto us, (for all
sudden and godly ejaculations are not to be condemned) which with good
...
at any time they pray, or bid the prayers before their sermons, there
...
faith\footnote{Sanders,
  ...
  and the common
conceit of the most reluctant [Catholics].}, to have abandoned all the ancient
...
which, out of the abundance of those partial affections that
...
the continual and curious disquisitions of many unnecessary questions
...
than with all the busy subtleties of the world. In which sense Saint
[Augustine] was wont
to say, that the pious and devout, though unlearned, went to Heaven,
while other men,
trusting to their learning, disputed it quite away\footnote{S. Aug.
  \textit{Veniunt indocti \& rapiunt coelum}: \& \textit{nos cum
doctrinis nostris detrudimur ad infernum.}}.

4. The last is, that those who perhaps are but coldly this way yet
affected, might
by others example be stirred up to the like heavenly duty of
...
servants we are,
and wherein our chiefest delight doth consist; we shall enjoy a
...
worthy, O Lord, to receive honor, and praise, and worship
for evermore.
...
preserve me now and forever. Amen.
...
may continually watch for thee, and both body and soul may rest in thy peace forever.
Amen.
